...
// ── БМК: этапы производства и расценки работ ────────────────────────────────
// Источник: «Прайс-лист на изготовление котельной и КНР» (ООО «НТ»). Разделы
// прайса = этапы производства БМК, позиции = сдельные расценки (bmkWorkRates).
// Чек-лист этапов — из требований ИТР в том же документе.
const BMK_STAGES = ["Каркас БМК", "Тепломеханика", "Газоснабжение", "Трубопроводы", "Мачта (металлоконструкция)", "Сэндвич панели", "Двери"];
const BMK_STAGE_CHECKLIST = [
  'Качество сборки и сварки (стыковые соединения с полным проваром)',
  'Качество зачистки сварных соединений',
  'Уборка и порядок на рабочем месте',
];
const BMK_WORK_RATES = [
  { stage: "Каркас БМК", name: "По основанию изделия (стандартное)", unit: "м²", price: 3000 },
  { stage: "Каркас БМК", name: "По основанию изделия (усиленная конструкция) т.е дополнительные усиления к стандартной конструкции", unit: "м²", price: 3500 },
  { stage: "Каркас БМК", name: "По основанию изделия с двойным дном и утеплителем", unit: "м²", price: 4000 },
  { stage: "Тепломеханика", name: "Обвязка настенного котла от 40 до 100 кВт", unit: "шт", price: 16000 },
  { stage: "Тепломеханика", name: "Обвязка настенного котла от 110 до 200 кВт", unit: "шт", price: 24000 },
  { stage: "Тепломеханика", name: "Обвязка напольного котла от 70 до 250 кВт", unit: "шт", price: 28560 },
  { stage: "Тепломеханика", name: "Обвязка напольного котла от 300 до 400 кВт", unit: "шт", price: 38080 },
  { stage: "Тепломеханика", name: "Обвязка напольного котла от 500 до 700 кВт", unit: "шт", price: 45900 },
  { stage: "Тепломеханика", name: "Обвязка напольного котла от 800 до 1400 кВт", unit: "шт", price: 54400 },
  { stage: "Тепломеханика", name: "Обвязка напольного котла от 1500 до 1800 кВт", unit: "шт", price: 63750 },
  { stage: "Тепломеханика", name: "Обвязка напольного котла от 2000 до 2200 кВт", unit: "шт", price: 74800 },
  { stage: "Тепломеханика", name: "Обвязка напольного котла от 2500 до 3500 кВт", unit: "шт", price: 108800 },
  { stage: "Тепломеханика", name: "Обвязка напольного котла от 4000 до 6000 кВт", unit: "шт", price: 142800 },
  { stage: "Тепломеханика", name: "Установка умягчения воды", unit: "шт", price: 12800 },
  { stage: "Тепломеханика", name: "Бак запаса воды", unit: "шт", price: 3000 },
  { stage: "Тепломеханика", name: "Подпиточный насос", unit: "шт", price: 8000 },
  { stage: "Тепломеханика", name: "Сетевой насос до Ду50", unit: "шт", price: 12800 },
  { stage: "Тепломеханика", name: "Сетевой насос от Ду65 до Ду100", unit: "шт", price: 18000 },
  { stage: "Тепломеханика", name: "Сетевой насос от Ду125 до Ду200", unit: "шт", price: 27000 },
  { stage: "Тепломеханика", name: "Сетевой насос от Ду225 до Ду315", unit: "шт", price: 32000 },
  { stage: "Тепломеханика", name: "Изготовление гидравлического разделителя", unit: "шт", price: 8000 },
  { stage: "Тепломеханика", name: "Узел учета тепловой энергии до Ду80", unit: "шт", price: 6400 },
  { stage: "Тепломеханика", name: "Узел учета тепловой энергии от Ду100 до Ду150", unit: "шт", price: 12800 },
  { stage: "Тепломеханика", name: "Счетчик холодной воды до Ду25", unit: "шт", price: 1000 },
  { stage: "Тепломеханика", name: "Счетчик холодной воды от Ду32 до Ду50", unit: "шт", price: 5000 },
  { stage: "Тепломеханика", name: "Счетчик холодной воды от Ду65", unit: "шт", price: 10000 },
  { stage: "Тепломеханика", name: "Расширительный бак до 200 литров", unit: "шт", price: 3000 },
  { stage: "Тепломеханика", name: "Расширительный бак до 2000 литров", unit: "шт", price: 6000 },
  { stage: "Тепломеханика", name: "Монтаж бойлера косвенного нагрева до 200 литров", unit: "шт", price: 8000 },
  { stage: "Тепломеханика", name: "Пластинчатый теплообменник 4 выхода до 89мм", unit: "шт", price: 18000 },
  { stage: "Тепломеханика", name: "Пластинчатый теплообменник 4 выхода от 100мм", unit: "шт", price: 25000 },
  { stage: "Тепломеханика", name: "Трехходовой клапан регулирующий до Ду50", unit: "шт", price: 9600 },
  { stage: "Тепломеханика", name: "Трехходовой клапан регулирующий от 65 до Ду100", unit: "шт", price: 16000 },
  { stage: "Тепломеханика", name: "Фильтр сетчатый фланцевый до Ду 80", unit: "шт", price: 8000 },
  { stage: "Тепломеханика", name: "Фильтр сетчатый фланцевый от Ду 100", unit: "шт", price: 12800 },
  { stage: "Тепломеханика", name: "Электромагнитный клапан до Ду 32", unit: "шт", price: 1000 },
  { stage: "Газоснабжение", name: "Горелка 1-2х ступенчатая до 700 кВт", unit: "шт", price: 24000 },
  { stage: "Газоснабжение", name: "Горелка 1-2х ступенчатая от 800 до 1400 кВт", unit: "шт", price: 32000 },
  { stage: "Газоснабжение", name: "Горелка 1-2х ступенчатая от 1500 до 2200 кВт", unit: "шт", price: 48000 },
  { stage: "Газоснабжение", name: "Горелка 1-2х ступенчатая от 2500 до 3500 кВт", unit: "шт", price: 64000 },
  { stage: "Газоснабжение", name: "Горелка 1-2х ступенчатая от 4000 до 6000 кВт", unit: "шт", price: 80000 },
  { stage: "Газоснабжение", name: "Горелка комбинированная", unit: "шт", price: null, note: "+50% к цене соответствующей горелки" },
  { stage: "Газоснабжение", name: "Электромагнитный клапан до 32 мм (резьбовое соединение)", unit: "шт", price: 2000 },
  { stage: "Газоснабжение", name: "Электромагнитный клапан фланцевый от Ду50", unit: "шт", price: 6400 },
  { stage: "Газоснабжение", name: "Узел учета газа от Ду32 до Ду50", unit: "шт", price: 3000 },
  { stage: "Газоснабжение", name: "Узел учета газа от Ду65 до Ду80", unit: "шт", price: 6000 },
  { stage: "Газоснабжение", name: "Узел учета газа от Ду100 до Ду150", unit: "шт", price: 8500 },
  { stage: "Газоснабжение", name: "Термозапорный клапан до 40 мм (резьбовое соединение)", unit: "шт", price: 1000 },
  { stage: "Газоснабжение", name: "Термозапорный клапан свыше 50 мм", unit: "шт", price: 3000 },
  { stage: "Газоснабжение", name: "Бак диз. топлива", unit: "шт", price: 16000 },
  { stage: "Трубопроводы", name: "Труба металлическая Ду15", unit: "м.п.", price: 130 },
  { stage: "Трубопроводы", name: "Труба металлическая Ду20", unit: "м.п.", price: 160 },
  { stage: "Трубопроводы", name: "Труба металлическая Ду25", unit: "м.п.", price: 200 },
  { stage: "Трубопроводы", name: "Труба металлическая Ду32", unit: "м.п.", price: 250 },
  { stage: "Трубопроводы", name: "Труба металлическая Ду40", unit: "м.п.", price: 320 },
  { stage: "Трубопроводы", name: "Труба металлическая Ду50", unit: "м.п.", price: 500 },
  { stage: "Трубопроводы", name: "Труба металлическая Ду70", unit: "м.п.", price: 600 },
  { stage: "Трубопроводы", name: "Труба металлическая Ду80", unit: "м.п.", price: 640 },
  { stage: "Трубопроводы", name: "Труба металлическая Ду100", unit: "м.п.", price: 800 },
  { stage: "Трубопроводы", name: "Труба металлическая Ду125", unit: "м.п.", price: 960 },
  { stage: "Трубопроводы", name: "Труба металлическая Ду150", unit: "м.п.", price: 1200 },
  { stage: "Трубопроводы", name: "Труба металлическая Ду200", unit: "м.п.", price: 1400 },
  { stage: "Трубопроводы", name: "Труба металлическая Ду250", unit: "м.п.", price: 1720 },
  { stage: "Трубопроводы", name: "Труба металлическая Ду300", unit: "м.п.", price: 1920 },
  { stage: "Трубопроводы", name: "Труба металлическая Ду400", unit: "м.п.", price: 2220 },
  { stage: "Мачта (металлоконструкция)", name: "Мачта размеры основания до (1000х1000) неразборная", unit: "м.п.", price: 6250 },
  { stage: "Мачта (металлоконструкция)", name: "Мачта размеры основания до (1000х1000) разборная", unit: "м.п.", price: 7450 },
  { stage: "Мачта (металлоконструкция)", name: "Мачта размеры основания до (1500х1500) неразборная", unit: "м.п.", price: 6900 },
  { stage: "Мачта (металлоконструкция)", name: "Мачта размеры основания до (1500х1500) разборная", unit: "м.п.", price: 8200 },
  { stage: "Мачта (металлоконструкция)", name: "Мачта размеры основания до (2000х2000) неразборная", unit: "м.п.", price: 7600 },
  { stage: "Мачта (металлоконструкция)", name: "Мачта размеры основания до (2000х2000) разборная", unit: "м.п.", price: 9000 },
  { stage: "Мачта (металлоконструкция)", name: "Мачта с одним шпилем (на одной трубе)", unit: "м.п.", price: 3000 },
  { stage: "Сэндвич панели", name: "Установка сэндвич панелей 50мм (стены, кровля) за 1 м2", unit: "м²", price: 400 },
  { stage: "Сэндвич панели", name: "Установка сэндвич панелей 80мм (стены, кровля) за 1 м2", unit: "м²", price: 450 },
  { stage: "Сэндвич панели", name: "Установка сэндвич панелей 100мм (стены, кровля) за 1 м2", unit: "м²", price: 500 },
  { stage: "Сэндвич панели", name: "Установка фасонных элементов на сэндвич панели за 1 м.п.", unit: "м.п.", price: 250 },
  { stage: "Сэндвич панели", name: "Вырезка и установка вентиляционных решеток за 1 шт", unit: "шт", price: 700 },
  { stage: "Сэндвич панели", name: "Вырезка отверстий под монтажные петли", unit: "шт", price: 250 },
  { stage: "Сэндвич панели", name: "Вырезка отверстий под трубы", unit: "шт", price: 250 },
  { stage: "Сэндвич панели", name: "Вырезка проемов в сендвич панели под окна и двери", unit: "шт", price: 500 },
  { stage: "Сэндвич панели", name: "Монтаж окон в котельной за 1 м2", unit: "м²", price: 1100 },
  { stage: "Сэндвич панели", name: "Монтаж дефлектора за 1 шт.", unit: "шт", price: 1000 },
  { stage: "Двери", name: "Монтаж заводских стандартных дверей", unit: "шт", price: 2000 },
  { stage: "Двери", name: "Изготовление и монтаж нестандартных дверей на производстве за 1 м2", unit: "м²", price: 2200 },
];
...
const EMPTY_DATA = {
  ...
  bomTemplates: [], materialConsumptions: [], productionStages: [], bmkWorkRates: [], defectReasons: [], workerAvailabilities: [], timesheet: {},
...
const migrateData = (d) => {
  ...
  // Миграция: этапы производства БМК (разделы прайс-листа работ по котельным).
  // Появляются один раз; дальше редактируются в Справочниках (тип «БМК»).
  if (!d.productionStages?.some(s => s.productType === 'bmk')) {
    d = { ...d, productionStages: [
      ...(d.productionStages || []),
      ...BMK_STAGES.map(name => ({ id: uid(), name, productType: 'bmk', checklist: BMK_STAGE_CHECKLIST.slice() })),
    ]};
    console.log('Миграция: добавлены этапы производства БМК (' + BMK_STAGES.length + ')');
  }
  // Миграция: справочник сдельных расценок на работы БМК (из прайс-листа)
  if (!d.bmkWorkRates || d.bmkWorkRates.length === 0) {
    d = { ...d, bmkWorkRates: BMK_WORK_RATES.map(w => ({ id: uid(), ...w })) };
    console.log('Миграция: загружены расценки работ БМК (' + BMK_WORK_RATES.length + ' позиций)');
  }
...
const BUNDLES = {
  ...
  office: ['cdn:xlsx', 'cdn:pdfmake', 'cdn:vfsFonts', 'cdn:chartjs',
           ...
           'js/gdrive.js', 'js/spec-parser.js', 'js/drawing-parser.js', 'js/reference.js', 'js/quality.js', 'js/hr.js',
